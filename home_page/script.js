...
target.innerHTML+=a.innerText+"<img src=/MindWeb.github.io-main/Images/A-img/Apple.jpg width=100px height=100px/>";
...
function B(){
    ...
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/B-img/ball.jpg width=100px height=100px/>";
    }
    function speakB(){
        if ("speechSynthesis" in window) {
    ...
    function C(){
        ...
        let target = document.getElementById('blanckarea');
        target.innerHTML+=a.innerHTML;
        target.innerHTML+="<img src=/MindWeb.github.io-main/Images/C-img/cat.png width=100px height=100px/>";
        }
        function speakC(){
            if ("speechSynthesis" in window) {
        ...
        function D(){
            ...
            let target = document.getElementById('blanckarea');
            target.innerHTML+=a.innerHTML;
            target.innerHTML+="<img src=/MindWeb.github.io-main/Images/D-img/dog.jpg width=100px height=100px/>";
            }
            function speakD(){
                if ("speechSynthesis" in window) {
            ...
            function E(){
                ...
                let target = document.getElementById('blanckarea');
                target.innerHTML+=a.innerHTML;
                target.innerHTML+="<img src=/MindWeb.github.io-main/Images/E-img/elephant.jpg width=100px height=100px/>";
                }
                function speakE(){
                    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/F-img/fish.png width=100px height=100px/>";
    }
    function speakF(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/G-img/grapes.jpg width=100px height=100px/>";
    }
    function speakG(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/H-img/horse.jpg width=100px height=100px/>";
    }
    function speakH(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/I-img/ice-cream.png width=100px height=100px/>";
    }
    function speakI(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/J-img/jug.png width=100px height=100px/>";
    }
    function speakJ(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/K-img/kite.png width=100px height=100px/>";
    }
    function speakK(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/L-img/lion.png width=100px height=100px/>";
    }
    function speakL(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/M-img/monkey.png width=100px height=100px/>";
    }
    function speakM(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/N-img/net.png width=100px height=100px/>";
    }
    function speakN(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/O-img/orange.png width=100px height=100px/>";
    }
    function speakO(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/P-img/parrot.jpg width=100px height=100px/>";
    }
    function speakP(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/Q-img/queen.jpg width=100px height=100px/>";
    }
    function speakQ(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/R-img/rabbit.jpg width=100px height=100px/>";
    }
    function speakR(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/S-img/sun.png width=100px height=100px/>";
    }
    function speakS(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/T-img/table.jpg width=100px height=100px/>";
    }
    function speakT(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/U-img/umbrella.png width=100px height=100px/>";
    }
    function speakU(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/V-img/violin.png width=100px height=100px/>";
    }
    function speakV(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/W-img/watch4.png width=100px height=100px/>";
    }
    function speakW(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/X-img/xmas-tree.png width=100px height=100px/>";
    }
    function speakX(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/Y-img/yatch.jpg width=100px height=100px/>";
    }
    function speakY(){
    if ("speechSynthesis" in window) {
    ...
    let target = document.getElementById('blanckarea');
    target.innerHTML+=a.innerHTML;
    target.innerHTML+="<img src=/MindWeb.github.io-main/Images/Z-img/zebra.png width=100px height=100px/>";
    }
    function speakZ(){
    if ("speechSynthesis" in window) {
